                    ...
                    <tbody>
                        @foreach ($staff as $staf)
                            <tr>
                                ...
                                <td class="text-center">{{ $staf->user->name }}</td>
                                <td class="text-center">{{ $staf->position->name }}</td>
                                <td class="text-center col-4">
                                    @if ($staf->user->image)
                                        <img src="/storage/{{ $staf->user->image }}" class="img-fluid p-1" alt="">
                                    @else
                                        <img src="https://via.placeholder.com/150" alt="NULL">
                                    @endif
                                </td>
                                <td class="col-2">
                                    <a class="btn btn-outline-warning m-1 col-12" href="/dashboard/staff/{{ $staf->id }}/edit">
