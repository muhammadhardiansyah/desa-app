            ...
            <ul class="menu">
                ...
                @can('admin')
                    ...
                    <li class="sidebar-item {{ $active == 'add_users' ? 'active' : '' }}">
                        <a href="/dashboard/users/create" class='sidebar-link'>
                    ...
                    <li class="sidebar-title">Staff</li>
                    <li class="sidebar-item {{ $active == 'dash_staff' ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item {{ $active == 'add_staff' ? 'active' : '' }}">
                        <a href="/dashboard/staff/create" class='sidebar-link'>
